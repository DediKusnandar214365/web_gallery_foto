      ...
      <div class="heading_container heading_center">
	   ...
	   <div class="row">
        <div class="col-md-12">
		  ...
		  <a href="print_data_komentar.php">+Print Komentar</a>
		  <br>
		  ...
		  <tbody  align="center">
			...
			<tr>
				...
				<td>		  
				<?php echo '
				  <a href="delete_komentar_admin.php?KomentarID='.$data['KomentarID'].'" class="btn btn-sm btn-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
				  ';?>
				</td>
			</tr>
			<?php
