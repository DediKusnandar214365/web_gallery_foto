      ...
      <div class="heading_container heading_center">
	   ...
	   <div class="row">
        <div class="col-md-12">
		  ...
		  <a href="print_data_album.php">+Print Album</a>
		  <br>
		  ...
		  <tbody  align="center">
			...
			<tr>
				...
				<?php echo '
				   <a href="delete_album.php?AlbumID='.$data['AlbumID'].'" class="btn btn-sm btn-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete
				  ';?>
				</td>
			</tr>
			<?php
