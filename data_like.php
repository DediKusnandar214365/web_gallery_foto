	   ...
	   <div class="row">
        <div class="col-md-12">
		  <form method="GET" action="" style="text-align: center;">
		    ...
		    <a href="print_data_like.php">+Print Like</a>
		  <br>
		  ...
		  <tbody  align="center">
			...
			<tr>
				...
				<td> 
					<?php echo '
					  <a href="delete_like_admin.php?LikeID='.$data['LikeID'].'" class="btn btn-sm btn-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
					  ';?>
				</td>
			</tr>
			<?php
