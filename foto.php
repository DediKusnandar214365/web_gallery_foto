...
<td><?php echo '
<a href="edit_foto.php?FotoID='.$data['FotoID'].'" class="badge badge-warning">Edit</a>
<a href="delete_foto.php?FotoID='.$data['AlbumID'].'" class="badge badge-danger"onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a> 
';?>
</td>
</tr>
<?php
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">kiomqxx</a>
      </p>
    </div>
  </footer>
  <!-- footer section -->
